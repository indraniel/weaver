...
func rscriptsInstallPackagesR() (*asset, error) {
	...
	info := bindataFileInfo{name: "Rscripts/install-packages.r", size: 4902, mode: os.FileMode(509), modTime: time.Unix(1441322546, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
